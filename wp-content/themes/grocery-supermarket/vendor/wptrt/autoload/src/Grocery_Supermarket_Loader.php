...
class Grocery_Supermarket_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function grocery_supermarket_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function grocery_supermarket_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function grocery_supermarket_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function grocery_supermarket_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->grocery_supermarket_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function grocery_supermarket_load( $class ) {
